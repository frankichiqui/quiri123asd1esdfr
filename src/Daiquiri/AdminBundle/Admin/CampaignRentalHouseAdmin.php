...
class CampaignRentalHouseAdmin extends AbstractAdmin {
    ...
    protected function configureFormFields(FormMapper $formMapper) {
        $formMapper
                ...
                ->add('rentalhouserooms', 'sonata_type_model', array(
                    'class' => 'Daiquiri\AdminBundle\Entity\RentalHouseRoom',
                    'property' => 'rentalhouseroomtitle',
                    'btn_add' => false,
                    'multiple' => true,
                    'by_reference' => false
                ))
                ...
                ->add('roomdiscount', 'money', array('currency' => 'USD', 'label' => 'Discount per room'))
                ->end()
