...
class CampaignTransferExclusiveAdmin extends AbstractAdmin {

    protected function configureRoutes(RouteCollection $collection) {
        $collection->add('form-create-campaign-transfer-exclusive-by-polo-and-type', 'form-create-campaign-transfer-exclusive-by-polo-and-type');
        $collection->add('create-campaign-transfer-exclusive-by-polo-and-type', 'create-campaign-transfer-exclusive-by-polo-and-type');
    }
    ...
    public function getTemplate($name) {
        switch ($name) {
            case 'list':
                return 'DaiquiriAdminBundle:CampaignTransferExclusive:campaign_transfer_exclusive_base_list.html.twig';
                break;
            default:
    ...
    protected function configureFormFields(FormMapper $formMapper) {
        $formMapper
                ...
                ->add('transfers', 'sonata_type_model', array(
                    'class' => 'Daiquiri\AdminBundle\Entity\TransferExclusive',
                    'property' => 'title',
                    'btn_add' => false,
                    'multiple' => true,
                    'by_reference' => false
                ...
                ->end()
                ->with("New Prices", array('class' => 'col-md-3'))
