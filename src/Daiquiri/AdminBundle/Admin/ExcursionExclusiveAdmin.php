...
class ExcursionExclusiveAdmin extends AbstractAdmin {

    public $routeitem = 'form-excursion-exclusive-searcher';

    protected function configureRoutes(RouteCollection $collection) {
        $collection->add('form-excursion-exclusive-searcher', $this->getRouterIdParameter() . '/form-excursion-exclusive-searcher');
        $collection->add('find-excursion-exclusive-searcher', $this->getRouterIdParameter() . '/find-excursion-exclusive-searcher');
    ...
    protected function configureFormFields(FormMapper $formMapper) {
        $formMapper
                ...
                ->add('excursionTypes')
                ->end()
                ->with('Excursion Place', array('class' => 'col-md-4'))
                ...
                ->add('polofrom', null, array('label' => 'Departure Destination'))
                ->end()
                ...
                ->add('saturday')
                ->end()
                ->with('Excursion Exclusive Block', array('class' => 'col-md-6'))
    ...
    protected function configureListFields(ListMapper $listMapper) {
        $listMapper
                ...
                ->addIdentifier('title', 'text', array('label' => 'Excursion Exclusive'))
                ...
                ->add('_action', 'actions', array(
                    'actions' => array(
                        ...
                        'form-excursion-exclusive-item' => array(
