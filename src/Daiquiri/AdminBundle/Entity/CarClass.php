 ...
 * @ORM\Entity(repositoryClass="Daiquiri\AdminBundle\Entity\CarClassRepository")
 */
class CarClass {
     ...
     * @ORM\SequenceGenerator(sequenceName="car_class_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     *
     * @ORM\OneToMany(targetEntity="Daiquiri\AdminBundle\Entity\Car", mappedBy="carClass")
     */
    private $cars;
