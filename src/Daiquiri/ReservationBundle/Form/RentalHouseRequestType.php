...
class RentalHouseRequestType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('captcha', null, array('label' => 'Captcha', 'attr' => array('class' => 'form-control'),
                    'required' => true))
                ->add('rentalhouse')
                ->add('rentalhouseroom', 'entity', array('class' => 'Daiquiri\AdminBundle\Entity\RentalHouseRoom', 'attr' => array('data-sonata-select2' => 'false')))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Daiquiri\ReservationBundle\Entity\RentalHouseRequest'
        ));
    }
    ...
    public function getName() {
        return 'daiquiri_reservationbundle_rentalhouserequest';
    }
