...
class TransferColectiveRequestType extends AbstractType {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Daiquiri\ReservationBundle\Entity\TransferColectiveRequest'
        ));
    }
    ...
    public function getName() {
        return 'daiquiri_reservationbundle_transfercplectiverequest';
    }
