...
class CircuitRequestType extends AbstractType {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Daiquiri\ReservationBundle\Entity\CircuitRequest'
        ));
    }
    ...
    public function getName() {
        return 'daiquiri_reservationbundle_circuitrequest';
    }
